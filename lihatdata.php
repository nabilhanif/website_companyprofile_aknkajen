...
$select = "select * from tbl_daftar_mahasiswa where id_daftar";
...
<th>Alamat</th><th>Kelurahan</th><th>Kecamatan</th><th>Kota</th><th>Provinsi</th><th>Telepon</th>
<th>Pilihan</th></tr>
...
<td>$tahunajaran</td><td>$alamat</td><td>$kelurahan</td><td>$kecamatan</td><td>$kota</td>
...
<center>
  <p>
    <input type="button" value="Input Data" onClick="window.location.href='daftaronline.php'">
  </p>
