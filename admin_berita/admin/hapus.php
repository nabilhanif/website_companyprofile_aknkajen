...
switch($_GET['data'])
{
    ...
    break;
	 ...
	 case 'list_daftar':
    $data=mysqli_fetch_row(mysqli_query($con,"select gambar from daftar where id='$id'"));
    unlink("../img/$data[0]");
    mysqli_query($con,"delete from daftar where id='$id'");
     header("location:index.php?page=list_daftar");
    break;
